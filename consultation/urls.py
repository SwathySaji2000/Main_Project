...
urlpatterns = [
    ...
    path('default/<am>/<id>',views.default),
    path('finish_payment/<booking_id>',views.finish_payment),
...
#    #path('success/', views.success_page, name='success_page'), 
    ...
    path('admin_view_treatments/', views.admin_view_treatment, name='admin_view_treatments'),
    # path('approve-treatment/<int:booking_id>/', views.approve_treatment, name='approve_treatment'),
   path('delete_booking/<int:booking_id>/', views.delete_booking, name='delete_booking'),
   path('approve_booking/<int:user_id>/<int:booking_id>/', views.approve_booking, name='approve_booking'),
